...
const HorizontalDivider = ({ text, className = "", variant = "solid", thickness = "normal" }: HorizontalDividerProps) => {
  ...
  return (
    <div className={`flex items-center gap-3 ${className} justify-center`}>
      ...
      {text && (
        <>
          <span className="text-xs uppercase tracking-[1.2px] text-brand-social-text">{text}</span>
