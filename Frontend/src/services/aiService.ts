...
[
  {"title": "tên gợi ý ngắn", "reason": "lý do ngắn gọn 1 câu", "searchKeyword": "từ khóa tìm kiếm"},
  {"title": "...", "reason": "...", "searchKeyword": "..."},
  {"title": "...", "reason": "...", "searchKeyword": "..."}
]`;
...
const getFallbackSuggestions = (category: string): AISuggestion[] => {
  const suggestions: Record<string, AISuggestion[]> = {
    ...
    "Quần": [
      { title: "Áo thun oversize", reason: "Phối thoải mái, trẻ trung", searchKeyword: "áo thun oversize" },
      { title: "Áo sơ mi trắng", reason: "Cổ điển, dễ phối với mọi loại quần", searchKeyword: "áo sơ mi trắng" },
      { title: "Áo hoodie", reason: "Casual, ấm áp và phong cách", searchKeyword: "áo hoodie" },
    ],
  };
