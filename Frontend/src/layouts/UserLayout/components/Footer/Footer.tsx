  ...
  return (
      <footer className="bg-[#F7F7F7] mt-20">
        <div className="max-w-[1200px] mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* COL 1 */}
          <div>
            <h2 className="text-xl font-bold text-[#4E6A4E]">
              The Sustainable Editorial
            </h2>

            <p className="mt-4 text-sm text-gray-600">
              © 2024 The Sustainable Editorial. <br />
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Nhận bản tin về thời trang bền vững hàng tuần.
            </p>
            ...
            <div className="flex items-center bg-white rounded-full overflow-hidden">
              <input
                  ...
                  className="flex-1 px-4 h-[44px] outline-none text-sm"
              />
              <button
                  className="bg-[#4E6A4E] text-white w-[44px] h-[44px] flex items-center justify-center">
