...
export default class User {
  ...
  constructor(email: string, role: string[], avatar?: string, hoDem?: string, name?: string, phone?: string, gioiTinh?: string, token?: Token, googleId?: string, hobby?: string, createAt?: string, birthday?: string, address?: string) {
