    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm relative z-10">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            onClick={onClose}
            className="text-gray-500 hover:cursor-pointer hover:text-gray-700 text-2xl font-bold transition"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="flex space-x-3">
          <button
            onClick={onClose}
            className="hover:cursor-pointer w-1/2 py-2 px-4 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition"
          >
            Cancel
          </button>
          <button
            onClick={onVerify}
            className="hover:cursor-pointer w-1/2 py-2 px-4 bg-green-700 text-white rounded-lg font-medium hover:bg-green-800 transition"
          >
            Verify
          </button>
        </div>
