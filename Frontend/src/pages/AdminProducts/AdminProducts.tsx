...
function AdminProducts() {
  return (
    <div>
      ...
      <div className="text-3xl p-10 m-2 flex justify-center items-center">Quản lý sản phẩm</div>
      <div className="my-4">
        <Link to="/admin/post" className="p-3 bg-brand-primary w-fit rounded-2xl text-white hover:cursor-pointer hover:opacity-85">Thêm sản phẩm</Link>
      </div>
      <ListProductTable />
    </div>
  );
